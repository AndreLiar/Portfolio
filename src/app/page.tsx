...
export default function Home() {
  const { data, Page, Header: headerData, Hero: heroData, ProjectList: projectListData, ProjectCard: projectCardData, Footer: footerData, ContactForm: contactFormData } = messages;
      ...
      <main className="flex-1">
        ...
        <section id="projects" className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <ProjectList 
              projects={projects}
              labels={projectListData}
              projectCardLabels={projectCardData}
            />
          </div>
        </section>
